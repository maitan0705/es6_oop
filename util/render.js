    ...
    switch (doiTuong) {
      ...
      <div class="form-group">
        <div class="input-group">
          ...
          <input type="number" name="toan" id="toan" class="form-control input-sm" placeholder="Điểm toán">
      ...
      <div class="form-group">
        <div class="input-group">
          ...
          <input type="number" name="ly" id="ly" class="form-control input-sm" placeholder="Điểm lý">
