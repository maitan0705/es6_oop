    ...
    case "student":
      {
        ...
        let valida = true;
        valida = valid(student)& check.checkNumber(student.toan, 'tbToan', 'Điểm', 0, 10)& check.checkNumber(student.ly, 'tbLy', 'Điểm', 0, 10)& check.checkNumber(student.hoa, '', 'Điểm', 0, 10)
        if(!valida) return ;
