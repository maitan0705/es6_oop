    ...
    case "customer":
      {
        ...
        let valida = true;
        valida = valid(customer)& check.checkText(customer.tenCongTy, 'tbTenCongTy', 'Tên Công ty')& check.checkNumber1(customer.hoaDon, 'tbHoaDon', 'Hóa đơn', 500000)&check.checkText(customer.danhGia, 'tbDanhGia', 'Đánh')
        if(!valida) return ;
