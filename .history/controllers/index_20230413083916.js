...
function valid(params) {
  var valid = true;
  valid = check.checkLength(params.ma, 'tbMa','Tài khoản', 4, 6, "error-tbMa")
 valid =check.checkName(params.hoTen, 'tbHoTen', 'Họ Tên', "error-tbHoTen") 
  valid =check.checkEmail(params.email, 'tbEmail',"Email",'error-tbEmail')
  valid =check.checkRong(params.diaChi, 'tbDiaChi',"Email")
