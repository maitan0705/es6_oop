...
document.querySelector("#btnThemNV").onclick = () => {
  /* `let personUser = document.querySelector("#doiTuong").value` is getting the value of the selected
  option from the dropdown menu with the id "doiTuong" and assigning it to the variable
  `personUser`. This value is then used in a switch statement to determine which type of person
  object to create and add to the list of persons. */
