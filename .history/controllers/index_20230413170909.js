    ...
    case "customer":
      {
        ...
        let valida = true;
        valida = valid(customer)& check.checkText(customer.tenCongTy, 'tbTenCongTy', 'Tên Công ty')& check.checkNumber1(customer.hoaDon, 'tbHoaDon', 'Hóa đơn', 500000)&check.checkText(cu)
        if(!valida) return ;
